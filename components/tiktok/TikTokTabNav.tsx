...
import { LayoutDashboard, Film, TrendingUp, Users } from 'lucide-react'
import { useSearchParams, useRouter, usePathname } from 'next/navigation'
import { cn } from '@/lib/utils'

export type TikTokTab = 'dashboard' | 'videos' | 'tendencias' | 'audiencia'
...
const VALID: TikTokTab[] = ['dashboard', 'videos', 'tendencias', 'audiencia']
